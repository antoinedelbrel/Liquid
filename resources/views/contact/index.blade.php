...
@section('content')
    <div id="contain" class="card bg-dark text-white">
        ...
        @endif
        <div id="back">
            <img src="{{ asset('images/soiree.png') }}" class="soiree card-img" alt="soiree">
            <div class="col-12 col-md-6 card-img-overlay">
                <form class="contact form-horizontal" method="POST" action="/contact">
                    ...
                    <div class="form-group card-text">
                        ...
                        <input type="text" class="form-control" id="objet" placeholder="Your objet" name="objet" required>
                    </div>
                    <div class="form-group card-text">
